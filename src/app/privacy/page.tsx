  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <article className="max-w-4xl mx-auto px-6 pt-32 pb-20 md:pt-40 md:pb-32">
        ...
        <div className="mb-16">
          <p className="text-indigo-600 uppercase tracking-[0.2em] text-sm font-bold mb-4">Legal & Compliance</p>
          <h1 className=" text-4xl md:text-5xl font-bold mb-6 text-slate-900">Privacy Policy</h1>
          <p className="text-slate-500 font-medium">Effective Date & Last Updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
        </div>

        <div className="prose prose-lg prose-slate max-w-none space-y-8 font-light text-slate-700">
          
          <div className="bg-slate-100 p-6 border-l-4 border-indigo-600 text-sm mb-12">
            <p className="font-bold mb-2 text-slate-900">Scope of this Policy</p>
            <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">1. Introduction and Definitions</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">2. Categories of Information We Collect</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">3. Sources of Information</h2>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">4. Business and Commercial Purposes for Data Use</h2>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">5. Cookies, Web Beacons, and Tracking Technologies</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">6. Text Messaging (SMS) & A2P 10DLC Compliance</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">7. Disclosure and Sharing of Personal Information</h2>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">8. State-Specific Privacy Rights (CCPA, CPRA, VCDPA, CPA)</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">9. Data Security Infrastructure</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">10. Data Retention</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">11. Third-Party Links</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">12. Children's Privacy (COPPA)</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">13. Changes to This Privacy Policy</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">14. Contact Us & Data Protection Inquiries</h2>
          ...
          <div className="bg-slate-100 p-6 border border-onyx/10 rounded-sm mt-6">
            <p className="font-bold mb-1">RAZ Transportation LLC</p>
            <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-3">Attn: Privacy & Operations</p>
            <p>2015 27TH ST SE, APT 105</p>
            <p>ST CLOUD, MN 56304</p>
            <p className="mt-4"><strong>Email:</strong> <a href="mailto:razdispatch1@raztransportationllc.com" className="text-indigo-600 hover:underline">razdispatch1@raztransportationllc.com</a></p>
            <p><strong>Phone:</strong> <a href="tel:218-313-1439" className="text-indigo-600 hover:underline">(218) 313-1439</a></p>
          </div>
        </div>
      </article>
