    ...
    <main className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <article className="max-w-4xl mx-auto px-6 pt-32 pb-20 md:pt-40 md:pb-32">
        ...
        <div className="mb-16">
          ...
          <h1 className=" text-4xl md:text-5xl font-bold mb-6 text-slate-900">Terms of Service</h1>
        ...
        <div className="prose prose-lg prose-slate max-w-none space-y-8 font-light text-slate-700">
          ...
          <div className="bg-slate-100 p-6 border-l-4 border-indigo-600 text-sm mb-12">
            <p className="font-bold mb-2 text-slate-900">Binding Agreement</p>
            <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">1. Introduction and Scope</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">2. Definitions</h2>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">3. Transportation Services and Conditions of Carriage</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">4. Bills of Lading (BOL) and Conflicting Terms</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">5. Rates, Quotes, and Payment Terms</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">6. Cargo Liability and Claims (The Carmack Amendment)</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">8. Intellectual Property and Website Usage</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">9. Disclaimer of Warranties</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">10. General Limitation of Liability</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">11. Governing Law, Venue, and Mandatory Arbitration</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">12. Modifications to the Terms</h2>
          <p>
          ...
          <h2 className=" text-2xl font-bold text-slate-900 mt-12 mb-4">13. Severability and Waiver</h2>
          <p>
          ...
          <div className="bg-slate-100 p-6 border border-onyx/10 rounded-sm mt-6">
            ...
            <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-3">Attn: Legal & Operations</p>
